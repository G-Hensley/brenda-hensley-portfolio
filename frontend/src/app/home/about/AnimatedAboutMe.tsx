...
export default function AnimatedAboutMe() {
  return (
    <div className="text-white text-4xl font-bold text-center lg:w-4/5 xl:w-3/4">
        <div className="grid grid-cols-6 gap-8 xl:gap-16">
            ...
            >
              <div className="flex gap-2 w-full justify-center items-center">
                ...
                <h3 className={`text-2xl md:text-3xl font-semibold text-green-600 shadow-lg ${electrolize.className} text-glow`}>Early Curiosity</h3>
              </div>
              <p className={`text-base md:text-[19px] leading-relaxed ${shareTechMono.className} text-left text-zinc-200`}>
            ...
            >
              <div className="flex gap-2 w-full justify-center items-center">
                ...
                <h3 className={`text-2xl md:text-3xl font-semibold text-green-600 shadow-lg ${electrolize.className} text-glow`}>Education Journey</h3>
              </div>
              <p className={`text-base md:text-[19px] leading-relaxed ${shareTechMono.className} text-left text-zinc-200`}>
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1 }}
                transition={{ duration: 2 }}
                className="col-span-6 xl:col-span-4 bg-zinc-900/30 p-4 rounded-lg border border-zinc-800 flex flex-col gap-4 shadow-glow"
            >
              <div className="flex gap-2 w-full justify-center items-center">
                <GlobeLock className="text-green-600 icon-glow" size={28} />
                <h3 className={`text-2xl md:text-3xl font-semibold text-green-600 shadow-lg ${electrolize.className} text-glow`}>Cybersecurity Experience</h3>
              </div>
              <p className={`text-base md:text-[19px] leading-relaxed ${shareTechMono.className} text-left text-zinc-200`}>
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1 }}
                transition={{ duration: 2 }}
                className="col-span-6 lg:col-span-3 xl:col-span-2 bg-zinc-900/30 p-4 rounded-lg border border-zinc-800 flex flex-col gap-4 shadow-glow"
            >
              <div className="flex gap-2 w-full justify-center items-center">
                <BriefcaseBusiness  className="text-green-600 icon-glow" size={28} />
                <h3 className={`text-2xl md:text-3xl font-semibold text-green-600 shadow-lg ${electrolize.className} text-glow`}>Motherhood & Career</h3>
              </div>
              <p className={`text-base md:text-[19px] leading-relaxed ${shareTechMono.className} text-left text-zinc-200`}>
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1 }}
                transition={{ duration: 2 }}
                className="bg-zinc-900/30 p-4 rounded-lg border border-zinc-800 flex flex-col gap-4 shadow-glow col-span-6 lg:col-span-3 xl:col-span-6"
            >
              <div className="flex gap-2 w-full justify-center items-center">
                <Globe className="text-green-600 icon-glow" size={28} />
                <h3 className={`text-2xl md:text-3xl font-semibold text-green-600 shadow-lg ${electrolize.className} text-glow`}>Why Cybersecurity?</h3>
              </div>
              <p className={`text-base md:text-[19px] leading-relaxed ${shareTechMono.className} text-center text-zinc-200`}>
